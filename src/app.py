...
def redirect_client_fundtransfer(message=None):
    if request.method == 'GET':
        ...
        Client.Client.transfer_fund(self_acc,recieving_acc,recieving_phone,int(Amount),Desc)
...
def redirect_client_account_summary(message=None):
    client=Client.Client.from_email(session['email'])
    print(client)
...
def login_client():
    ...
    client = Client.Client.from_name(name)
    global tempvalue
    tempvalue=name
    ...
    if client is not None:
        ...
        session['email'] = None
    return make_response(login_client("Incorrect login Please try again"))
...
def login_admin():
    ...
    if name=="Saksham":
        ...
        session['email'] = None
    return make_response(login_admin("Incorrect login Please try again"))
...
def admin_view_clients_templateas(message=None):
    clients=Client.Client.all_clients()
...
def delete_client():
    ...
    client = Client.Client.from_id(name)
